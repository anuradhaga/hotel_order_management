...
import { EarningsReportData } from "@/core/data/json/earningsReportData";
...
const EarningReportComponent = () => {
  const [rows, _setRows] = useState<DataRow[]>(
    () =>
      (EarningsReportData as TableData[] | any).map((row: any, idx: any) => ({
        ...row,
            ...
            <div className="col-sm-12">
              <div className="card mb-0">
                <div className="card-body">
                  <div className="border-bottom earning-report-filter-wrap">
...
export default EarningReportComponent;

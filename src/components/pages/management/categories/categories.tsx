...
const CategoriesComponent = () => {
  const [rows, setRows] = useState<DataRow[]>(
    () =>
      (CategoriesData as TableData[]).map((row, idx) => ({
        ...row,
  ...
  const baseColumns = useMemo(
    () => [
        ...
        render: (text: string, record: any) => (
          <div className="d-flex align-items-center">
            <Link href="#" className="avatar avatar-sm avatar-rounded flex-shrink-0 me-2">
              <ImageWithBasePath src={`assets/img/category/${record.image}`} alt="category" className="img-fluid" />
            </Link>
      ...
      },
      {
        title: "No of Items",
        dataIndex: "No_Items",
        sorter: (a: DataRow, b: DataRow) => a.No_Items.length - b.No_Items.length,
      },
      {
        title: "Date",
        dataIndex: "Date",
          ...
          <>
            ...
            <Link
              ...
              onClick={() =>
                setPendingDelete({
                  ...record,
                  key: record.key || record.category || record.id || "",
                })
              }
            >
        ...
        <div className="content">
          ...
          <div className="d-flex align-items-sm-center flex-sm-row flex-column gap-3 mb-4">
            ...
            <div className="gap-2 d-flex align-items-center flex-wrap">
              ...
              <Link href="#" className="btn btn-primary d-inline-flex align-items-center" data-bs-toggle="modal" data-bs-target="#add_category"><i className="icon-circle-plus me-1"></i>Add New</Link>
        ...
        <div className="modal-dialog modal-dialog-centered modal-sm">
          <div className="modal-content">
            <div className="modal-body text-center p-4">
              ...
              <p className="mb-4">
                {pendingDelete
                  ? <>Are you sure you want to delete <br /> {pendingDelete.category}?</>

                    ...
                    <div className="d-flex align-items-center flex-wrap mb-1">
                      ...
                      <div className="theme-colorselect m-1 me-2"  onClick={() => handleUpdateTheme("data-sidebar", "sidebar5")}>
                        ...
                        <label
                          ...
                          className="d-block rounded bg-orange mb-2"
                        >
                          <span className="theme-check rounded-circle">
                            <i className="ti ti-check" />
                          </span>
                      ...
                      <div className="theme-colorselect m-1 me-2" onClick={() => handleUpdateTheme("data-sidebar", "sidebar7")}>
                        ...
                        <label
                          ...
                          className="d-block rounded bg-purple mb-2"
                        >
                          <span className="theme-check rounded-circle">
                            <i className="ti ti-check" />
                          </span>
                    ...
                    <div className="d-flex align-items-center flex-wrap">
                      ...
                      <div className="theme-colorselect m-1 me-2" onClick={() => handleUpdateTheme("data-sidebar", "gradientsidebar3")}>
                        ...
                        <label
                          ...
                          className="d-block rounded bg-pink-gradient"
                        >
                          <span className="theme-check rounded-circle">
                            <i className="ti ti-check" />
                          </span>
                      ...
                      <div className="theme-colorselect m-1 me-2" onClick={() => handleUpdateTheme("data-sidebar", "gradientsidebar6")}>
                        ...
                        <label
                          ...
                          className="d-block rounded bg-danger-gradient"
                        >
                          <span className="theme-check rounded-circle">
                            <i className="ti ti-check" />
                          </span>
                      ...
                      <div className="theme-colorselect m-1" onClick={() => handleUpdateTheme("data-sidebar", "gradientsidebar7")}>
                        ...
                        <label
                          ...
                          className="d-block rounded bg-teal-gradient"
                        >
                          <span className="theme-check rounded-circle">
                            <i className="ti ti-check" />
                          </span>
                    ...
                    <div className="d-flex align-items-center flex-wrap topbar-background mb-1">
                      ...
                      <div className="theme-colorselect mb-3 me-3" onClick={() => handleUpdateTheme("data-topbar", "topbar4")}>
                        <input
                          ...
                          readOnly
                        />
                        <label htmlFor="topbar4Topbar" className="bg-orange">
                          <span className="theme-check rounded-circle">
                            <i className="ti ti-check" />
                          </span>
                        </label>
                      ...
                      <div className="theme-colorselect mb-3" onClick={() => handleUpdateTheme("data-topbar", "topbar6")}>
                        <input
                          ...
                          readOnly
                        />
                        <label htmlFor="topbar6Topbar" className="bg-purple">
                          <span className="theme-check rounded-circle">
                            <i className="ti ti-check" />
                          </span>
                        </label>
                ...
                <div className="accordion-body pb-2">
                  <div className="theme-content">
                    <div className="d-flex align-items-center flex-wrap">
                      ...
                      <div className="theme-colorsset me-2 mb-2" onClick={() => handleUpdateTheme("data-color", "info")}>
                        <input
                          type="radio"
                          name="data-color"
                          id="infoColor"
                      ...
                      <div className="theme-colorsset me-2 mb-2" onClick={() => handleUpdateTheme("data-color", "pink")}>
                        <input
                          type="radio"
                          name="data-color"
                          id="pinkColor"
                          defaultValue="pink"
                          checked={
                            themeSettings["data-color"] === "pink"
                          }
                          readOnly
                        />
                        <label htmlFor="pinkColor" className="pink-clr" />
                      </div>
                      <div className="theme-colorsset mb-2" onClick={() => handleUpdateTheme("data-color", "teal")}>
                        <input
                          type="radio"
                          name="data-color"
                          id="tealColor"
